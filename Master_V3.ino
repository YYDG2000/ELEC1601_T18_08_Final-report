...
void setup()
{
    ...
    //read the click input from joystick
...
void loop()
{
    ...
    while(1)
    {
        ...
        }else if (x >= 500 && x <= 550 && y >= 500 && y <= 550){
              //middle
        ...
        }else if (x >= 500 && y >= 768 && y <= 1024){
              //straight
              blueToothSerial.print('c');
              
        }else if (x >= 768 && y <= 550 && x <= 1024){
              //right
              blueToothSerial.print('d');
              
        }else if (y <= 20 && x >= 256 && x <= 550){
              //backward
        ...
        if (button == 1){ //button is on
            blueToothSerial.print('g');
        }
        if (recvChar == 'h'){
            Serial.println("The rebort is in a dark environment!")
        }
